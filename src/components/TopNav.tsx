    ...
    <>
      <nav className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <a
            href="#browse"
            className="text-muted hover:text-text transition-colors text-sm font-light tracking-wide"
          >
            Browse
          </a>
          <a
        ...
        <button
          className="md:hidden flex items-center justify-center w-8 h-8 text-muted hover:text-text transition-colors"
          onClick={toggleMenu}
