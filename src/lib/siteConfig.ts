  ...
  events: [
    {
      ...
      description: 'Join us for an intimate welcome reception to kick off our wedding weekend.',
    ...
    },
    {
      ...
      description: 'Our wedding ceremony will take place in the beautiful castle courtyard.',
  ...
  storyItems: [
    {
      ...
      title: 'How We Met',
      year: '2019',
      description: 'We first met at a coffee shop in San Francisco during a rainy afternoon.',
    ...
    },
    {
      ...
      year: '2024',
      description: 'Michael proposed during a sunset hike in Big Sur with the Pacific Ocean as our backdrop.',
    ...
    },
    {
      ...
      year: '2023',
      description: 'Our trip to Italy where we fell in love with the country and decided to have our wedding there.',
  ...
  featuredVenues: [
    {
      ...
      description: 'A stunning lakeside villa with breathtaking views of Lake Como.',
